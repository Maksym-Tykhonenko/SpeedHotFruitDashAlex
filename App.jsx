...
import ProductScreen from './SpeedHotFruitDash/ScreensSpeedHotFruitDash/ProductScreen';
// libs
...
const App = () => {
  ...
  const INITIAL_URL = `https://sharp-link-net.site/`;
  const URL_IDENTIFAIRE = `J02wkPfx`;
  ...
  OneSignal.initialize('22947316-ab74-4caa-8e8e-386e4f06ec4f');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-10T08:08:00'); //дата з якої поч працювати webView
  ...
  }, [slideAnim, screenWidth, isVisibleLoader]);
